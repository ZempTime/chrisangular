...
describe('parse', function() {
  ...
  it('parses a computed access with another key as a property', function() {
  ...
  it('binds bare functions on locals to locals', function() {
    var scope = {};
    var locals = {
      aFunction: function() {
        return this;
  ...
  it('does not allow referencing a window', function() {
    var fn = parse('wnd');
    expect(function() {
      fn({wnd: window});
    }).toThrow();
