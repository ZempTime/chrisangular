...
describe('Scope', function() {
  ...
  describe('$evalAsync', function() {
    ...
    // this test causes a phantomjs timeout/disconnect
  ...
  describe('inheritance', function() {
    ...
    it('can watch a property in the scopes parent', function() {
      var parent = new Scope();
      var child = parent.$new();
      parent.aValue = [1, 2, 3];
      child.counter = 0;
    ...
    it('does not shadow members of a parent scopes attributes', function() {
      var parent = new Scope();
      var child = parent.$new();
  ...
  describe('$watchCollection', function() {
    ...
    it('gives the old value object to listeners', function() {
  ...
  describe('events', function() {
    ...
    _.forEach(['$emit', '$broadcast'], function(method) {
      ...
      it('is sets the defaultPrevented when preventDefault called on '+method, function() {
    ...
    it('sets currentScope to null after propogation on $emit', function() {
      var event;
    ...
    it('sets currentScope to null after propogation on $broadcast', function() {
      var event;
      var scopeListener = function(evt) {
        event = evt;
      };
